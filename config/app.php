...
return [
    ...
    */
    ...
    'quiz_disabled' => env('QUIZ_DISABLED', false),

    'chat_enabled' => env('CHAT_ENABLED', false),

    'send_chat_without_auth' => env('SEND_CHAT_SESSION_FOR_UNAUTHORIZED_USERS', false),

    'backups_enabled' => env('BACKUPS_ENABLED', false),

    'deal_allow_skip_file_upload' => env('DEAL_ALLOW_SKIP_DOCUMENT_UPLOAD', false),
