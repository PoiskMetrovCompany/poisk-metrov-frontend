<?php  //[STAMP] a6759a905ee9c693117d65cc173dd114
// phpcs:ignoreFile
...
trait ApiTesterActions
{
     ...
     * $I->amActingAs($user);
     * ```
     * @see \Codeception\Module\Laravel::amActingAs()
     */
    public function amActingAs(\Illuminate\Contracts\Auth\Authenticatable $user, ?string $guardName = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Condition('amActingAs', func_get_args()));
    }
     ...
     * @see \Codeception\Module\Laravel::amLoggedAs()
     */
    public function amLoggedAs($user, ?string $guardName = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Condition('amLoggedAs', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::assertAuthenticatedAs()
     */
    public function assertAuthenticatedAs(\Illuminate\Contracts\Auth\Authenticatable $user, ?string $guardName = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertAuthenticatedAs', func_get_args()));
    }
     ...
     * ]);
     * ```
     * @see \Codeception\Module\Laravel::assertCredentials()
     */
    public function assertCredentials(array $credentials, ?string $guardName = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertCredentials', func_get_args()));
    }
     ...
     * ]);
     * ```
     * @see \Codeception\Module\Laravel::assertInvalidCredentials()
     */
    public function assertInvalidCredentials(array $credentials, ?string $guardName = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertInvalidCredentials', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::dontSeeAuthentication()
     */
     ...
     * @see \Codeception\Module\Laravel::dontSeeAuthentication()
     */
    public function cantSeeAuthentication(?string $guardName = NULL): void {
     ...
     * $I->logout();
     * ```
     * @see \Codeception\Module\Laravel::logout()
     */
     ...
     * $I->seeAuthentication();
     * ```
     * @see \Codeception\Module\Laravel::seeAuthentication()
     */
     ...
     * @see \Codeception\Module\Laravel::seeAuthentication()
     */
    public function canSeeAuthentication(?string $guardName = NULL): void {
     ...
     *
     * @return string|void
     * @see \Codeception\Module\Laravel::callArtisan()
     */
    public function callArtisan(string $command, array $parameters = [], ?\Symfony\Component\Console\Output\OutputInterface $output = NULL) {
     ...
     * ```
     * @see \Codeception\Module\Laravel::clearApplicationHandlers()
     */
    public function clearApplicationHandlers(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearApplicationHandlers', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::getApplication()
     */
     ...
     *
     * @return mixed
     * @see \Codeception\Module\Laravel::grabService()
     */
     ...
     * });
     * ```
     * @see \Codeception\Module\Laravel::haveApplicationHandler()
     */
    public function haveApplicationHandler(callable $handler): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveApplicationHandler', func_get_args()));
    }
     ...
     * @param bool $shared
     * @see \Codeception\Module\Laravel::haveBinding()
     */
    public function haveBinding(string $abstract, $concrete = NULL, bool $shared = false): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveBinding', func_get_args()));
    }
     ...
     * @see \Codeception\Module\Laravel::haveContextualBinding()
     */
    public function haveContextualBinding(string $concrete, string $abstract, $implementation): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveContextualBinding', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::haveInstance()
     */
    public function haveInstance(string $abstract, object $instance): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveInstance', func_get_args()));
    }
     ...
     * @param string $abstract
     * @param Closure|string|null $concrete
     * @see \Codeception\Module\Laravel::haveSingleton()
     */
    public function haveSingleton(string $abstract, $concrete): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveSingleton', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\Laravel::setApplication()
     */
    public function setApplication(\Illuminate\Contracts\Foundation\Application $app): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('setApplication', func_get_args()));
    }
     ...
     * @part orm
     * @see \Codeception\Module\Laravel::dontSeeRecord()
     */
     ...
     * @see \Codeception\Module\Laravel::dontSeeRecord()
     */
    public function cantSeeRecord($table, $attributes = []): void {
     ...
     *
     * @part orm
     * @see \Codeception\Module\Laravel::grabNumRecords()
     */
     ...
     * @part orm
     * @see \Codeception\Module\Laravel::grabRecord()
     */
     ...
     * @return mixed
     * @part orm
     * @see \Codeception\Module\Laravel::have()
     */
     ...
     * @part orm
     * @see \Codeception\Module\Laravel::haveMultiple()
     */
     ...
     * @part orm
     * @see \Codeception\Module\Laravel::haveRecord()
     */
     ...
     * @part orm
     * @see \Codeception\Module\Laravel::make()
     */
     ...
     * @return EloquentCollection|EloquentModel
     * @part orm
     * @see \Codeception\Module\Laravel::makeMultiple()
     */
     ...
     * @see \Codeception\Module\Laravel::seedDatabase()
     */
    public function seedDatabase($seeders): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seedDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Codeception\Module\Laravel::seedDatabase()
     */
    public function canSeedDatabase($seeders): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seedDatabase', func_get_args()));
    }
     ...
     *
     * @part orm
     * @see \Codeception\Module\Laravel::seeNumRecords()
     */
     ...
     * @see \Codeception\Module\Laravel::seeNumRecords()
     */
    public function canSeeNumRecords(int $expectedNum, string $table, array $attributes = []): void {
     ...
     * @param array $attributes
     * @part orm
     * @see \Codeception\Module\Laravel::seeRecord()
     */
     ...
     * @see \Codeception\Module\Laravel::seeRecord()
     */
    public function canSeeRecord($table, $attributes = []): void {
     ...
     * $I->disableEvents();
     * ```
     * @see \Codeception\Module\Laravel::disableEvents()
     */
    public function disableEvents(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('disableEvents', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::disableModelEvents()
     */
    public function disableModelEvents(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('disableModelEvents', func_get_args()));
    }
     ...
     * @see \Codeception\Module\Laravel::dontSeeEventTriggered()
     */
     ...
     * ```
     * @param string|object|string[] $expected
     * @see \Codeception\Module\Laravel::seeEventTriggered()
     */
     ...
     * ```
     * @see \Codeception\Module\Laravel::disableExceptionHandling()
     */
    public function disableExceptionHandling(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('disableExceptionHandling', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::enableExceptionHandling()
     */
    public function enableExceptionHandling(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('enableExceptionHandling', func_get_args()));
    }
     ...
     * @see \Codeception\Module\Laravel::amOnAction()
     */
     ...
     * @param mixed $params
     * @see \Codeception\Module\Laravel::amOnRoute()
     */
     ...
     * ```
     * @see \Codeception\Module\Laravel::seeCurrentActionIs()
     */
     ...
     * ```
     * @see \Codeception\Module\Laravel::seeCurrentRouteIs()
     */
     ...
     * @see \Codeception\Module\Laravel::dontSeeInSession()
     */
     ...
     * @see \Codeception\Module\Laravel::dontSeeInSession()
     */
    public function cantSeeInSession($key, $value = NULL): void {
     ...
     * ```
     * @see \Codeception\Module\Laravel::dontSeeSessionHasValues()
     */
    public function dontSeeSessionHasValues(array $bindings): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeSessionHasValues', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Codeception\Module\Laravel::dontSeeSessionHasValues()
     */
    public function cantSeeSessionHasValues(array $bindings): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeSessionHasValues', func_get_args()));
    }
     ...
     * $I->flushSession();
     * ```
     * @see \Codeception\Module\Laravel::flushSession()
     */
    public function flushSession(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('flushSession', func_get_args()));
    }
     ...
     * ```
     * @see \Codeception\Module\Laravel::haveInSession()
     */
     ...
     * @param string|array $key
     * @param mixed|null $value
     * @see \Codeception\Module\Laravel::seeInSession()
     */
     ...
     * @see \Codeception\Module\Laravel::seeInSession()
     */
    public function canSeeInSession($key, $value = NULL): void {
     ...
     * ```
     * @see \Codeception\Module\Laravel::seeSessionHasValues()
     */
     ...
     * $I->dontSeeFormErrors();
     * ```
     * @see \Codeception\Module\Laravel::dontSeeFormErrors()
     */
     ...
     * ```
     * @see \Codeception\Module\Laravel::seeFormErrorMessage()
     */
     ...
     * @see \Codeception\Module\Laravel::seeFormErrorMessage()
     */
    public function canSeeFormErrorMessage(string $field, ?string $errorMessage = NULL): void {
     ...
     * ]);
     * ```
     * @see \Codeception\Module\Laravel::seeFormErrorMessages()
     */
     ...
     * $I->seeFormHasErrors();
     * ```
     * @see \Codeception\Module\Laravel::seeFormHasErrors()
     */
     ...
     * @see \Codeception\Module\Laravel::disableMiddleware()
     */
    public function disableMiddleware($middleware = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('disableMiddleware', func_get_args()));
    }
     ...
     *
     * @param string|array|null $middleware
     * @see \Codeception\Module\Laravel::enableMiddleware()
     */
    public function enableMiddleware($middleware = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('enableMiddleware', func_get_args()));
    }
