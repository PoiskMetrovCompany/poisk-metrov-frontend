...
return new class extends Migration {
    ...
    {
        Schema::create('complex_apartments', function (Blueprint $table) {
            $table->id();
            //ID квартиры из фида
            $table->string('offer_id', 64);
            //ID комплекса
            $table->foreignId('building_id')->constrained('complex_buildings');
            //Цена квартиры
            ...
            $table->string('balcony', 255)->nullable()->default(null);
            ...
            $table->string('bathroom_unit', 255)->nullable()->default(null);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('complex_apartments');
    }
};
