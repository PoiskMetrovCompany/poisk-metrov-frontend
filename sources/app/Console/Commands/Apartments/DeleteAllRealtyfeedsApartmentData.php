...
class DeleteAllRealtyfeedsApartmentData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:delete-all-realtyfeeds-apartment-data';
    ...
    {
        $apartmentService = ApartmentService::getFromApp();
        $apartments = Apartment::where('feed_source', '<>', 'nmarket')->get();
        echo "{$apartments->count()} have feed source other than nmarket and will be deleted" . PHP_EOL;
