...
class CatalogFilterController extends AbstractOperations
{
     ...
     *     operationId="filterCatalogLegacy",
     ...
     *         in="query",
     *         required=false,
     *         description="Алиас параметра search",
     *         @OA\Schema(type="string", example="Брусника")
     *     ),
     *
     *     @OA\Response(
     *         response=200,
