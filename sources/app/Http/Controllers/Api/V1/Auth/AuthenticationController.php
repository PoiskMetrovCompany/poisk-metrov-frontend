 ...
 */
class AuthenticationController extends AbstractOperations
{
     ...
     * @param AdsAgreementService $adsAgreementService
    ...
    public function __construct(
        ...
        protected AdsAgreementService $adsAgreementService,
     ...
     * summary="Определение аккаунта (сайт)",
     ...
     * @return JsonResponse
     */
    public function __invoke(ConfirmUserRequest $request)
    {
