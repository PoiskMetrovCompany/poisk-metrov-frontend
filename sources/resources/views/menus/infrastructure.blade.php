<div id="infrastructure-menu" class="sub-menus background">
    <div class="infrastructure card common-padding">
        <div class="infrastructure container">
            <div class="sub-menus top">
                <div class="sub-menus header">
                    ...
                    <div class="sub-menus close">
                        <div class="icon action-close grey3"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="infrastructure menu bottom-buttons">
