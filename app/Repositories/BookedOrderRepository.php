...
use App\Core\Interfaces\Repositories\BookedOrderRepositoryInterface;
...
final class BookedOrderRepository implements BookedOrderRepositoryInterface
{
    use ListQueryTrait;
    use StoreQueryTrait;
