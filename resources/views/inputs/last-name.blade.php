<div class="input-container">
    <fieldset class="input-fieldset">
        <legend class="input-legend">{{ $nameInputTitle ?? 'Ваша фамилия' }}<span
                class="red-highlight">{{ $required ?? '' }}</span></legend>
        <div class="input-wrapper">
            <input class="input-text {{ $style ?? '' }}" type="text" id="last_name" name="last_name" required
                   placeholder={!! $placeholder ?? 'Введите&nbsp;вашу&nbsp;фамилию' !!}
